        ...
        <form method="POST" action="{{ route('articles.store') }}">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="short_description" id="short_description" rows="3" 
                          style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">{{ old('short_description') }}</textarea>
            </div>
            
            <div style="margin-bottom: 15px;">
                <label for="content" style="display: block; margin-bottom: 5px; font-weight: bold;">Содержание *</label>
                <textarea name="content" id="content" rows="10" 
                          style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px;" required>{{ old('content') }}</textarea>
            </div>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <small style="color: #666;">Пример: https://picsum.photos/640/480</small>
            </div>
            
            <div style="display: flex; gap: 10px;">
                <button type="submit" style="background: #27ae60; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;">Сохранить</button>
